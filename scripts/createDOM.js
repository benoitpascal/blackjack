...
function createDOM() {
    ...
    // Création de la structure principale de la page
    header = createBalise("header", body, "flexColumn")
    main = createBalise("main", body, "flexCenter")
    footer = createBalise("footer", body, "flexCenter")
    ...
    playBtn = createButton('Jouer', main);
